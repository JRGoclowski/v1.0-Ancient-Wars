...
public:
	...
	board state. 
	*/
	virtual std::vector<std::unique_ptr<AWGameMove>> GetPossibleMoves() const = 0;
	...
	*/
	virtual void ApplyMove(std::unique_ptr<AWGameMove> move) = 0;
	...
	*/
	virtual const std::vector<std::unique_ptr<AWGameMove>>& GetMoveHistory() const = 0;
